...
namespace gpr5300 {
class HelloTexture final : public Scene {
 public:
  void Begin() override;
  void End() override;
...
void HelloTexture::LoadTexture(GLuint& texture, const char* file_path) {
...
void HelloTexture::CreateProgram(const char* file_path_vertex_shader,
                                 const char* file_path_fragment_shader) {
  // Load shaders
...
void HelloTexture::Begin() {
  LoadTexture(texture_, "data/textures/monkey.png");
  CreateProgram("data/shaders/hello_texture/texture.vert",
                "data/shaders/hello_texture/texture.frag");
...
void HelloTexture::Update(float dt) {
  // Draw program
