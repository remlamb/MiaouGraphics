...
namespace gpr5300 {
class HelloTransform final : public Scene {
 public:
  void Begin() override;
  void End() override;
...
void HelloTransform::LoadTexture(GLuint& texture, const char* file_path) {
...
void HelloTransform::CreateProgram(const char* file_path_vertex_shader,
                                   const char* file_path_fragment_shader) {
  // Load shaders
...
void HelloTransform::Begin() {
  LoadTexture(texture1_, "data/textures/deep.png");
  LoadTexture(texture2_, "data/textures/deep2.png");
  CreateProgram("data/shaders/hello_transform/texture.vert",
                "data/shaders/hello_transform/texture.frag");
  ...
  trans = glm::scale(trans, glm::vec3(2.4, 1.8, 0.5));
  // trans = glm::translate(trans, glm::vec3(0.5f, -0.5f, 0.0f));
 }

void HelloTransform::End() {
...
void HelloTransform::Update(float dt) {
  // Draw program
  ...
  glUniformMatrix4fv(glGetUniformLocation(program_, "transform"), 1, GL_FALSE,
                     glm::value_ptr(trans));
