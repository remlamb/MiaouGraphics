...
namespace gpr5300 {
class HelloIBLMultipleLight final : public Scene {
 public:
  void Begin() override;
  void End() override;
...
void HelloIBLMultipleLight::Begin() {
...
void HelloIBLMultipleLight::End() {
  // Unload program/pipeline
  cubemaps_.Delete();
}

void HelloIBLMultipleLight::renderScene(Pipeline& shader) {
  glm::mat4 model = glm::mat4(1.0f);
...
void HelloIBLMultipleLight::Update(float dt) {
  // colorBuffer.Reset();
  model = glm::mat4(1.0f);
  timer_ += dt;
...
int main(int argc, char** argv) {
  gpr5300::HelloIBLMultipleLight scene;
